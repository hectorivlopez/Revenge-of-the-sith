...
public class Draw3d {
    ...
    public static void calPolyhedronFaces(int[][][] levels, int[] ignoreFaces, int direction, ArrayList<Surface> allSurfaces, int[] director, String projection, Color borderColor, Color color/*, HashMap<Color, int[]> colors*/, BufferedImage buffer) {
        int numLevels = levels.length;
        int numVertices = levels[0][0].length;
